...
in argos_plugin.__init__ (not agent.turn_context) and ride the native
...
try:
    from argos_plugin import _build_file_activity_hint
    _pkg_name = "argos_plugin"
except ImportError:
    from argos import _build_file_activity_hint
    _pkg_name = "argos"
