...
|-----|-----------|------|------|
| **A. Fork (dev)** | `C:\Users\<user>\Documents\Github\Hermes` | full git repo | origin = `github.com/bobaba76/Argos`. This is where all code changes and commits happen. |
...
```bash
cd /c/Users/<user>/Documents/Github/Hermes
...
```bash
REPO="/c/Users/<user>/Documents/Github/Hermes/hybrid_memory_plugin"
