...
def run_conversation(
    ...
    _timestamp_hint = _ctx.timestamp_hint
    _location_hint = _ctx.location_hint
    _weather_hint = _ctx.weather_hint
    _file_activity_hint = _ctx.file_activity_hint
    ...
    _turn_exit_reason = "unknown"  # Attributetic: why the loop ended
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if response_invalid:
                    ...
                    # Extract error code from response for contextual attributetics
                ...
                if (
                    ...
                    if agent._try_refresh_nous_client_credentials(force=True):
                        ...
                        continue
                    # Credential refresh didn't help — show attributetic info.
                ...
                if (
                    ...
                    if is_token_provider(key):
                        ...
                        print(f"{agent.log_prefix}   Run `hermes doctor` for credential-chain attributetics, or")
